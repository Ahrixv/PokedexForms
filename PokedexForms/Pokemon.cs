...
namespace PokedexForms
{
    ...
    {
        public static Contributor FromJson(string json) => JsonConvert.DeserializeObject<Contributor>(json, PokedexForms.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Contributor self) => JsonConvert.SerializeObject(self, PokedexForms.Converter.Settings);
    }
